from CommonFunctions import initialiseQValues, updateStateValuesfromQ, clearStateValues, calculateMSE, printVStates, \
    printStates
...
for i in range(0, 20):
    ...
    while iterations < maxIterations:
        ...
        step = runEpisodeSARSA(states, alpha, gamma, epsilon)
